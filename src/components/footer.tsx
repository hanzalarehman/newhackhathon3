...
//                         <Link href="javascript:;"  className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900">
...
//                           </svg>
//                         </Link>
//                         <Link href="javascript:;"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
//                         ">
...
//                         </Link>
//                         <Link href="javascript:;"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
...
//                         </Link>
//                         <Link href="javascript:;"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
...
//                         <li >61-A, Elm street, karachi, Pakistan.</li>
//                     </ul>
//                 </div>
...
//                         <li className="sm:mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Features</a></li>
//                     </ul>
//                 </div>
...
//                         <li><Link href="javascript:;"  className="text-sm text-gray-500">Terms</Link></li>
//                         <li><Link href="javascript:;"  className="text-sm text-gray-500">Privacy</Link></li>
//                         <li><Link href="javascript:;"  className="text-sm text-gray-500">Cookies</Link></li>
//                     </ul>
//                 </div>
//             </div>
//         </div>
...
function Footer() {
  return (
    <div className="bg-gray-100 py-5  px-4 md:py-10 md:px-6">
    {/* Footer Content */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-6 max-w-screen-xl mx-auto">
    ...
    {/* Footer Bottom */}
    {/* <hr className="my-3 md:my-6 border-gray-300" /> */}
    <p className="text-start md:text-center text-gray-600 text-sm">2022 Meubel House. All rights reserved.</p>
  </div>
