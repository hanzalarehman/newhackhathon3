...
// type AsgaardSofaProps = {
//   params: {
//     slug: string;
//   };
// };

// function AsgaardSofa({ params }: AsgaardSofaProps) {
//   const [receiveData, setReceiveData] = useState<any>(null);
//   const [loading, setLoading] = useState<boolean>(true);
...
//               </span>
//             </div>
//             <p className="mt-4 text-gray-700 text-sm sm:text-base">{receiveData.description}</p>
...
//             <span className="text-gray-400">Reviews [5]</span>
//           </h3>
//           <p className="text-sm sm:text-base leading-6">{receiveData.description}</p>
//         </div>

//         {/* Related Products */}
//         <h2 className="text-2xl sm:text-3xl font-medium mt-8">Related Products</h2>
//         <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-6">
...
// // Define the correct type for the props.
// type AsgaardSofaProps = {
//   params: { // Make sure this matches the expected type.
//     slug: string;
//   };
// };
...
export default function AsgaardSofa({ params }: AsgaardSofaProps) {
  const [receiveData, setReceiveData] = useState<any>(null);
  const [loading, setLoading] = useState<boolean>(true);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (resolvedParams?.slug) {
        const query = `*[_type == 'product' && slug.current == "${resolvedParams.slug}"]{
          id,
          _id,
          price,
          imagePath,
